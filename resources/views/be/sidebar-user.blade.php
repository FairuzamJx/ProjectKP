...
<aside class="main-sidebar sidebar-dark-primary elevation-3">
    ...
    <a href="/pages/dashboard" class="brand-link">
        <img src="{{ asset('img') }}/logom.png" alt="AdminLTE Logo" class="brand-image img-circle  elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">Limarsa Gentari Utama</span>
    </a>
